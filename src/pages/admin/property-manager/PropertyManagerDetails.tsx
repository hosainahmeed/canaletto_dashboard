        ...
        <FormalCard header="Manager Information">
          ...
          <div className="flex gap-2 mt-6">
            <Button
              ...
              className='bg-linear-to-bl to-brand from-[#B08D59] py-5'>
              <HugeiconsIcon icon={UserEdit01Icon} />Block This Manager </Button>
            <Button
             
              className='bg-linear-to-bl to-red-900 from-red-500 py-5'><HugeiconsIcon icon={LockPasswordIcon} />Delete This Manager</Button>
          </div>
      </PageContent>
    </PageLayout>
  )
