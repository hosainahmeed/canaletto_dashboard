        ...
        <PageContent>
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-8 border-b border-gray-100">
              <h2 className="text-2xl font-semibold text-gray-800 italic font-nunito-semibold-italic">Update Legal Update</h2>
              <p className="text-sm text-gray-400 mt-1 italic">Edit Legal Update Details</p>
            </div>
