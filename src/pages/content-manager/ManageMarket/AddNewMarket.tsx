  ...
  const handleSavePost = () => {
    if (validateForm()) {
      ...
      const imageFiles = images.map((base64String, index) => {
        ...
        return new File([blob], `market_image_${index + 1}.jpg`, { type: 'image/jpeg' })
      })

      console.log('Market Update Data:')
      console.log('market_image=', imageFiles)
      console.log('market_title=', title)
      console.log('market_description=', content)
      ...
      alert('Market update saved successfully!')
    } else {
        ...
        <PageContent>
          <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
            ...
            <div className="p-10 space-y-10">
              ...
              {/* Title Input */}
              <Field >
                <FieldLabel className="text-base font-medium text-gray-600 block">Market Update Tittle</FieldLabel>
