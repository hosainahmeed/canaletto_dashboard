            ...
            <Select>
              ...
              <SelectContent>
                <SelectGroup>
                  ...
                  <SelectItem value="dining">Beach & Waterfront</SelectItem>
                  <SelectItem value="dining">Dining & Cafés</SelectItem>
                  <SelectItem value="dining">Shopping & Entertainment</SelectItem>
                  <SelectItem value="dining">City Guides</SelectItem>
                </SelectGroup>
              </SelectContent>
            </Select>
